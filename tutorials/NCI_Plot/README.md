...
8. In terminal run cd `/Applications/VMD\ 2.0.0a7-pre2.app/Contents/MacOS/`
9. In terminal run `source /Applications/VMD\ 2.0.0a7-pre2.app/Contents/MacOS/RDGfill.vmd`
